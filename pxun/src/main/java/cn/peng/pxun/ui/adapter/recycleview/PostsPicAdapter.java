...
public class PostsPicAdapter extends RecyclerView.Adapter<PostsPicAdapter.ViewHolder> {
    ...
    public PostsPicAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_posts_pic, viewGroup, false);
